...
# Load known faces
Kolhi_image = face_recognition.load_image_file("Faces/Kolhi.jpg")
Kolhi_encoding = face_recognition.face_encodings(Kolhi_image)[0]
...
known_face_encodings = [Kolhi_encoding,Rohit_encoding, Rahul_encoding]
known_face_names = ["Kolhi","Rohit", "Rahul"]
